...
with open('../pkgs/spoldzielnie/spoldzielnie/dane/spoldzielnie_krs_dane3.csv', 'w') as f:
...
df.to_csv('../pkgs/spoldzielnie/spoldzielnie/dane/spoldzielnie_df_4.csv', index=False)